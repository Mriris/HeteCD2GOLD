...
# - 若不传命令行参数，将使用这里的默认值
# - 命令行参数依然可覆盖这些默认值
CHECKPOINT = r'checkpoints\gold\trios43\EXP20251103122205_config_C_balanced\gold_398IoU66.72.pth'
TEST_DIR = r'D:\0Program\Datasets\241120\Compare\Datas\Split45\test'
OUTPUT_DIR = r'results3'
BATCH_SIZE = 4
DEVICE = 'cuda'
