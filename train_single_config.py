...
用法:
    python train_single_config.py config_A
    python train_single_config.py config_B
    python train_single_config.py config_C
"""
...
from configs_weight_ablation import get_config, ALL_CONFIGS
...
def main():
    ...
    if len(sys.argv) < 2:
        print("错误: 请指定配置名称")
        print()
        print("用法: python train_single_config.py <config_name>")
        print()
        print("可用配置:")
    ...
    print(f"预期损失占比: {config['expected_loss_ratio']}")
    print("=" * 100 + "\n")
